...
export default function ProductsPage() {
  ...
  return (
    <>
      {/* ── Hero ── */}
      <section className="relative overflow-hidden" style={{ minHeight: '45vh', background: '#0E5F13' }}>
        <NovaOrb size={700} x="80%" y="40%" color1="#ECBD27" color2="#0E5F13" opacity={0.15} duration={10} />
        <NovaOrb size={400} x="10%" y="70%" color1="#ECBD27" color2="#0a3d0a" opacity={0.1} duration={7} delay={2} />
